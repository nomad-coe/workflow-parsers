...
fhivibes_parser_entry_point = EntryPoint(
    ...
    mainfile_contents_dict={'__has_key': r'I|calculator'},
    mainfile_mime_re='(application/x-hdf)|(application/json)',
...
phonopy_parser_entry_point = EntryPoint(
    ...
    mainfile_name_re=r'(.*/(phonopy-)?(?:FHI-aims-)?disp(?:lacement)?[-_]0*1/control\.in$)|(.*phon.*\.ya?ml$)',
    mainfile_contents_re=r'(phonopy|displacement|supercell|primitive|band|mesh)',
