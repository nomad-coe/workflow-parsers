...
fhivibes_parser_entry_point = EntryPoint(
    ...
    mainfile_contents_dict={'__has_key': r'^aims_uuid$'},
    mainfile_mime_re='(application/x-hdf)|(application/octet-stream)',
...
fhivibes_son_parser_entry_point = EntryPoint(
    name='parsers/fhivibes-son',
    aliases=['parsers/fhivibes-son'],
    description='NOMAD parser for FHIVIBES SON trajectories.',
    python_package='workflowparsers.fhivibes',
    mainfile_contents_dict={'__has_all_keys': ['atoms', 'calculator', 'vibes']},
    mainfile_mime_re='(application/json)|(text/.*)',
    mainfile_name_re=r'^.*\.(son)$',
    mainfile_alternative=True,
    parser_class_name='workflowparsers.fhivibes.FHIVibesParser',
    code_name='FHI-vibes',
    code_homepage='https://vibes.fhi-berlin.mpg.de/',
    ...
    metadata={
        ...
        'preamble': '',
        'status': 'production',
        'tableOfFiles': '|Input Filename| Description|\n|--- | --- |\n|`*.son` | **Mainfile**, serialized FHI-vibes trajectory |\n',
    },
)
