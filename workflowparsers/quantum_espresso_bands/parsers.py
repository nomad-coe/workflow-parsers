...
class QuantumEspressoBandsParser:
    ...
    def parse(self, filepath, archive, logger):
        ...
        if pwscf_files:
            self.logger.info(
                f'Using PWSCF file: {pwscf_files[0]} for electronic structure data'
            )
